...
class DefaultConversationsArchiveMethod(private val authToken: String) : ConversationsArchiveMethod() {

    override fun request(): ApiCallResult<SuccessfulConversationArchiveResponse, ErrorConversationArchiveResponse> {
        val response = SlackRequestBuilder<ConversationArchiveResponse>(authToken)
                .with(this.params)
